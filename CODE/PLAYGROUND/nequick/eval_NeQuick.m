...
sat_lat = sat_pos.ph/pi*180;  	% latitude [deg]
sat_lon = sat_pos.la/pi*180;  	% longitude [deg]
...
ray = Ray((pos_geo.h/1000.0), pos_geo.ph/pi*180, pos_geo.la/pi*180, (sat_pos.h/1000.0), sat_lat, sat_lon);
