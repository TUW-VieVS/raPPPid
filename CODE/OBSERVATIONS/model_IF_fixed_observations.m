function [model_code_fix, model_phase_fix] = ...
    model_IF_fixed_observations(model, Epoch, param_float)
...
model_code_fix = model.rho...                        	% theoretical range
    ...
    + rec_clk_gps.*isGPS + rec_clk_glo.*isGLO + rec_clk_gal.*isGAL + rec_clk_bds.*isBDS + rec_clk_qzs.*isQZS... 	% receiver clock
